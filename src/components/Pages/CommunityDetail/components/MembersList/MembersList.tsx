        ...
        <MemberListContainer>
          {members.map(memberItem => (
            <MemberItem key={memberItem.memberAddress}>
              <MemberAvatarContainer>
                <MemberAvatar src={memberItem.profilePictureUrl} backgroundColor={getRandomRarityColor(theme)} />
              </MemberAvatarContainer>
              <MemberInfo>
                <Box display="flex" alignItems="center">
                  <MemberName>{memberItem.name}</MemberName>
                  {memberItem.hasClaimedName && <ClaimedNameIcon data-testid="claimed-name-icon" aria-label="Claimed name badge" />}
                </Box>
